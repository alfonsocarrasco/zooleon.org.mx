        ...
        <div style="max-width: 600px;margin: 0 auto;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" class="email-container">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;border-spacing: 0 !important;border-collapse: collapse !important;table-layout: fixed !important;">
                <tr style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                    <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background: #009E3A;position: relative;z-index: 0;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;">
                        <a href="<?= WEB_EMPRESA; ?>" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;color: #c7007d;font-size: 24px;font-weight: 700;font-family: 'Lato', sans-serif;">
                            <img src="<?= media(); ?>images/logotipo_zoo.png" alt="" style="width: 250px;max-width: 300px;height: auto;margin: auto;display: block;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;-ms-interpolation-mode: bicubic;">
                        </a>
                    </td>
                </tr>
                <!-- end tr -->
                            ...
                            <tr style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                <td style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;">
                                    <div class="text" style="padding: 0 2.5em;text-align: center;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: rgba(0, 0, 0, .3);">
                                        <p>Estimado/a:
                                            <?= $data['nombreUsuario']; ?></p>
                                        <h2 style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: 'Lato', sans-serif;color: #000;margin-top: 0;font-weight: 400;font-size: 40px;margin-bottom: 0;line-height: 1.4;">Instrucciones para iniciar sesión</h2>
                                        <h3 style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: 'Lato', sans-serif;color: #000000;margin-top: 0;font-weight: 300;font-size: 24px;">Haz clic en el botón para iniciar sesión.</h3>
                                        <p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Usuario:
                                            <span style="color: #312031; font-weight: bold;">
                                                <?= $data['email']; ?>
                                            </span>
                                        </p>
                                        <p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Password: <span style="color: #312031; font-weight: bold;"><?= $data['password']; ?></span>
                                        </p>
                                        <p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;"><a href="<?= base_url(); ?>" class="btn btn-primary" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;color: #ffffff;padding: 10px 15px;display: inline-block;border-radius: 5px;background: #c7007d;">Iniciar Sesión</a></p>
                                    </div>
                                </td>
                            </tr>
                        </table>
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;border-spacing: 0 !important;border-collapse: collapse !important;table-layout: fixed !important;">
                <tr style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                    <td class="bg_light" style="text-align: center;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background: #fafafa;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;">
                        <p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Por favor no respondas a este email. <a href="<?= WEB_EMPRESA; ?>" style="color: rgba(0, 158, 58,.8);-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;">www.zooleon.org.mx</a></p>
                    </td>
                </tr>
                <!-- end: tr -->
            </table>
