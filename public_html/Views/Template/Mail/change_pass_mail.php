                            ...
                            <tr style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                <td style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;">
                                    <div class="text" style="padding: 0 2.5em;text-align: center;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: rgba(0, 0, 0, .3);">
                                        ...
                                        <h2 style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: 'Lato', sans-serif;color: #000;margin-top: 0;font-weight: 400;font-size: 40px;margin-bottom: 0;line-height: 1.4;">Instrucciones para restablecer contraseña</h2>
                                        <h3 style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: 'Lato', sans-serif;color: #000000;margin-top: 0;font-weight: 300;font-size: 24px;">Haz clic en el botón para restablecer la contraseña de tu cuenta.</h3>
                                        <p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;"><a href="<?= $data['url_recovery']; ?>" class="btn btn-primary" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;color: #ffffff;padding: 10px 15px;display: inline-block;border-radius: 5px;background: #c7007d;">Restablecer contraseña</a></p>

                                        <p>¿El botón no funciona? Copie y pegue la siguiente URL en tu navegador.</p>
                                        <span><?= $data['url_recovery']; ?></span>

                                        <p>Si no solicitaste restablecer tu contraseña, por favor haz caso omiso a este e-mail.</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
