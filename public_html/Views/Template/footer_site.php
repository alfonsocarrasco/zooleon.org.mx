    ...
    <script>
        ...
        if (document.querySelector('#mapa')) {
            ...
            marker.bindPopup(
                '<div class="d-flex justify-content-center mb-3"><img src="<?= media(); ?>site/images/logo-leon_veda.svg" alt="" class="logo-foot"></div><h5 style="text-align: center"><b><?= $data['infogral']['title_contacto']; ?></b></h5><h5 style="text-align: center"><?= $data['infogral']['direccion']; ?></h5>'
            ).openPopup();
