<!-- Modal -->
<div class="modal fade" id="modalFormPageTransparencia" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header headerRegister">
                <h5 class="modal-title" id="titleModal">Editar Página Transparencia</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form id="formPageTransparencia">
                        <input type="hidden" id="idpagetransparencia" name="idpagetransparencia" value="0">
