<!-- Modal -->
<div class="modal fade" id="modalFormPrivacidad" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form id="formPrivacidad">
                        <input type="hidden" id="idPrivacidad" name="idPrivacidad" value="0">
                        ...
                        <div class="border p-3 rounded">
                            ...
                            <div class="row g-1">
                                ...
                                <div class="mb-3 col-12">
                                    <label for="txtDescripcion" class="form-label">Descripción Política de Privacidad <span class="required">*</span></label>
