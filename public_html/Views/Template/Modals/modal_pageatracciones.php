<!-- Modal -->
<div class="modal fade" id="modalFormPageAtracciones" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form id="formPageAtracciones">
                        <input type="hidden" id="idpageatracciones" name="idpageatracciones" value="0">
                        ...
                        <div class="border p-3 rounded">
                            ...
                            <div class="row g-1">
                                ...
                                <div class="form-floating mb-3 col-12">
                                    ...
                                    <textarea type="text" class="form-control" id="txtContenido" name="txtContenido" placeholder="Contenido"></textarea>
                                </div>
                            </div>
                            <div class="row g-1">
