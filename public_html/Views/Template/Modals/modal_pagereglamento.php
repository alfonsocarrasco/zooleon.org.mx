<!-- Modal -->
<div class="modal fade" id="modalFormPageReglamento" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form id="formPageReglamento">
                        <input type="hidden" id="idpageregla" name="idpageregla" value="0">
                        ...
                        <div class="border p-3 rounded">
                            ...
                            <div class="row g-1">
                                ...
                                <div class="form-floating mb-3 col-12">
                                    <input type="text" class="form-control" id="txtFrase" name="txtFrase" placeholder="Ingresa una frase">
                                    <label for="txtFrase" class="form-label">Ingresa una frase <span class="required">*</span></label>
                                </div>
                            </div>
                            <div class="row g-1">
                                <div class="form-floating mb-3 col-12">
