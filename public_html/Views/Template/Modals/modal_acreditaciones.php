<!-- Modal -->
<div class="modal fade" id="modalFormAcreditaciones" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header headerRegister">
                <h5 class="modal-title" id="titleModal">Nueva Acreditación</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form id="formAcreditaciones">
                        <input type="hidden" id="idAcreditacion" name="idAcreditacion" value="0">
                        ...
                        <div class="border p-3 rounded">
                            ...
                            <div class="row g-1">
                                <div class="form-floating mb-3 col-12">
                                    <input type="text" class="form-control" id="txtNameAcreditacion" name="txtNameAcreditacion" placeholder="Ingrese el nombre de la acreditación">
                                    <label for="txtNameAcreditacion" class="form-label">Nombre de la Acreditación <span class="required">*</span></label>
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="foto" class="form-label">Agregar una foto de (330x110)px ó (110x170)px</label>
...
<!-- Modal View User -->
<div class="modal fade" id="modalViewAcreditacion" tabindex="-1" aria-hidden="true">
