<?php
    headerAdmin($data);
    getModal('modal_pageejemplares', $data);
?>
                    ...
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td></td>
                                <td class="parallax2"></td>
                            </tr>
                            <tr>
                                <td>Nombre Especie</td>
                                <td></td>
                                <td class="nameespecie2"></td>
                            </tr>
                            <tr>
                                <td>Nombre Científico</td>
                                <td></td>
                                <td class="namescientific2"></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
                                <td class="parallax3"></td>
                            </tr>
                            <tr>
                                <td>Nombre Especie</td>
                                <td></td>
                                <td class="nameespecie3"></td>
                            </tr>
                            <tr>
                                <td>Nombre Científico</td>
                                <td></td>
                                <td class="namescientific3"></td>
                            </tr>
                            <tr>
                                <td>Estatus</td>
                                <td class="status"></td>
