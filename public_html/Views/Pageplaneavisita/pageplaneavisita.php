<?php
    headerAdmin($data);
    getModal('modal_pagereglamento', $data);
?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Frase página</td>
                                <td class="frase">Lorem ipsum dolor sit amet.</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>Nombre Especie</td>
                                <td></td>
                                <td class="nameespecie">Lorem ipsum dolro sit amet.</td>
                            </tr>
                            <tr>
                                <td>Nombre Científico</td>
                                <td></td>
                                <td class="namescientific">Lorem ipsum dolro sit amet.</td>
                            </tr>
                            <tr>
                                <td>Estatus</td>
                                <td class="status"><span class="badge rounded-pill bg-danger">Lorem</span></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
